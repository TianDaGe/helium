...
UniValue addnode(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2 ||
        ...
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("addnode", "\"192.168.0.6:5005\" \"onetry\"") + HelpExampleRpc("addnode", "\"192.168.0.6:5005\", \"onetry\""));
...
UniValue getaddednodeinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "    \"addresses\" : [\n"
            "       {\n"
            "         \"address\" : \"192.168.0.201:5005\",  (string) The 401KCoin server host and port\n"
